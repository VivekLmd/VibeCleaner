...
def claude(prompt: str, model: str | None = None) -> str:
    ...
    timeout = float(os.environ.get("VIBECLEANER_PROVIDER_TIMEOUT", "0") or 0) or None
    start = time.time()
    ...
    if code != 0:
        hint = "Install the Claude CLI or set VIBECLEANER_CLAUDE_CMD to your binary."
...
def codex(prompt: str, model: str | None = None) -> str:
    ...
    if code != 0:
        hint = "Install the Codex CLI or set VIBECLEANER_CODEX_CMD to your binary."
